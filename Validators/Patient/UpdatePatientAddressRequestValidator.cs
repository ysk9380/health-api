...
public class UpdatePatientAddressRequestValidator : AbstractValidator<UpdatePatientAddressRequest>
{
    public UpdatePatientAddressRequestValidator()
    {
        RuleFor(x => x.PatientAddressId)
