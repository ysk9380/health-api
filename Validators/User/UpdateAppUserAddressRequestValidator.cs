...
public class UpdateAppUserAddressRequestValidator : AbstractValidator<UpdateAppUserAddressRequest>
{
    public UpdateAppUserAddressRequestValidator()
    {
        RuleFor(x => x.AppUserAddressId)
